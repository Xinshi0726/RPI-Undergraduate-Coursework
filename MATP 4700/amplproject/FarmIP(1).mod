...
subject to TechLimitedUBa{t in TECHlimited}: sum{c in CROPS, f in FIELDSa} usetech[c,f,t] <= 100*limited[t]; 

subject to TechLimitedUBb{t in TECHlimited}: sum{c in CROPS, f in FIELDSb} usetech[c,f,t] <= 100*(1-limited[t]);