...
maximize profits: totalrevenue - techcosts - (sum {a in FIELDSa} techfieldcost[a,'water']*(perbasea*usetech[a,'water']) + sum {b in FIELDSb} techfieldcost[b,'water']*(perbaseb*usetech[b,'water']) + 402*(halfbasea+halfbaseb) + 800*(bothbases));
...
subject to perbothineq: sum{a in FIELDSa} usetech[a,'water'] + sum{b in FIELDSb} usetech[b,'water']>= 20*bothbases;

subject to perahalfineq: sum{a in FIELDSa} usetech[a,'water'] >= 10*halfbasea;

subject to perbhalfineq: sum{b in FIELDSb} usetech[b,'water'] >= 10*halfbaseb;