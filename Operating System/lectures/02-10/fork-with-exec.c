...
int main()
{
  ...
  if ( rc == 0 )
  {
    ...
    execl( "/usr/bin/ls", "ls",    "-l",   "sizeof.c",  NULL );
#endif

#if 0
                      /* argv[0], argv[1], argv[2],    argv[3] */
    execl( "/usr/bin/xyz", "ls",    "-l",   "sizeof.c",  NULL );
#endif
    ...
    /* if we reach this point of the code, execl() returned -1 */

    printf( "CHILD: !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n" );
    printf( "CHILD: returned from execl(); something is wrong\n" );
    perror( "execl() failed" );
